...
public class FirstController : NetworkBehaviour, ISceneController, UserAction {
    
    UserGUI userGUI;
    public Queue<GameObject> Patrols = new Queue<GameObject>();
    ...
    private void AddScore()
    {
        //if (Player != null)
        //{
        //    Player.GetComponent<Score>().AddScore(10);
        //}
        userGUI.Score++;
    }
    ...
    private void GameOver()
    {
        ...
        if (Player != null)
        {
            ...
            //Player.GetComponent<Score>().AddScore(-50);
        }
